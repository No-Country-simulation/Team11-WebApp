  ...
  return (
    <main className="flex max-w-7xl mx-auto">
      <section className="max-w-sm">
        ...
        <p className="flex justify-center items-center w-sm rounded-md mt-4 mb-2 text-Green font-bold gap-2 py-2 px-4 bg-white border-2 border-gray-200 shadow-gray-700 shadow-sm">
          Solicitudes nuevas esta semana
        </p>
        <p className="flex justify-center items-center w-sm rounded-md mb-2  text-Green font-bold gap-2 py-2 px-4 bg-white border-2 border-gray-200 shadow-gray-700 shadow-sm">
          Documentación pendiente de revisión
        </p>
      </section>

      <section className="flex flex-col py-2 px-6">
        <h1 className="text-Green text-2xl font-extrabold">
          ¿Cómo funciona la pre-evaluación de riesgo?
        </h1>
        <p className="mb-4 mt-2">
          La plataforma realiza una pre-evaluación automática de cada solicitud
          según el historial financiero y los indicadores de la pyme.
        </p>
        <p className="mb-4">
          Estos indicadores sirven como guia inicial para el análisis del
          operador, pero no determinan la decisión final del crédito.
        </p>
        <p className="mb-4">
          Los resultados se muestran con un semáforo de riesgo:
        </p>
        ...
        <p className="self-start ml-6 mt-2">
          Perfil confiable, sin incidencias detectadas. <br />
          Historial sólido. Documentación completa.
        </p>
        ...
        <p className="self-start ml-6 mt-2">
          Se recomienda revisión manual de documentación. <br />
          Historial regular. Documentación parcial.
        </p>
        ...
        <p className="self-start ml-6 mt-2">
          Riesgo elevado, posible rechazo o revisión detallada. <br />
          Deuda previa, Ingresos inconsistentes. Documentación insuficiente.
        </p>

        <h2 className="self-start ml-6 mt-6 text-Green font-bold text-2xl">
